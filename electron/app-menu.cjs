 ...
 * edição: sem ele, ⌘C, ⌘V, ⌘Z e ⌘A param de funcionar dentro dos campos — inclusive no Taby, que é
 * onde a pessoa mais digita. Por isso o menu é montado de qualquer forma.
 */
function buildAppMenuTemplate({ appName = 'Hibi' } = {}) {
  return [
...
/**
 * Tira o Hibi do Dock e do ⌘Tab: ele vive na barra de menus, com o notch à vista. `dock` só existe
