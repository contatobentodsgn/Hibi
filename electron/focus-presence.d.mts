...
export type FocusLoopAnimationId = 'working_laptop_normal_loop' | 'listening_music_loop';
...
export declare function resolveFocusLoopAnimationId(preference: FocusLoopAnimation | undefined): FocusLoopAnimationId;
