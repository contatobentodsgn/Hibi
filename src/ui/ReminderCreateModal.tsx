      ...
      <form onSubmit={submit}>
        ...
        <div style={{ display: 'grid', gap: 16, padding: '22px 20px' }}>
          ...
          <fieldset><legend>Schedule</legend><div style={{ display: 'grid', gap: 12 }}>
            ...
            <label style={{ display: 'grid', gap: 7 }}>Date<input type="date" value={date} onChange={(event) => setDate(event.target.value)} required /></label>
            <label style={{ display: 'grid', gap: 7 }}>Time<input type="time" value={time} onChange={(event) => setTime(event.target.value)} required /></label>
