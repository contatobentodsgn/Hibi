...
// sempre visível (ver NoteForm com titleId="new-note-title"), nunca este diálogo.
...
function NoteForm({ editor, folders, onCancel, onSubmit, titleId }: { editor: { id?: string; title: string; content: string; folder: string }; folders: readonly string[]; onCancel?: () => void; onSubmit: (title: string, content: string, folder: string) => void; titleId: string }) {
