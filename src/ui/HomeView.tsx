...
type Props = { onEvent: (action: string, detail: string, result?: string) => void; onNavigate: (route: any) => void; onOpenCommands?: () => void };
export function HomeView({ onEvent, onNavigate, onOpenCommands }: Props) { return <div className="home-view">
  <div className="eyebrow">MONDAY · 07 SEPTEMBER 2026 <span className="pill green">LOCAL STUDY MODE</span></div>
