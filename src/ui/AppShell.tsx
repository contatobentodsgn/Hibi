...
export type NavKey = 'home' | 'tasks' | 'notes' | 'reminders' | 'habits' | 'goals' | 'review' | 'taby' | 'help' | 'feedback' | 'day' | 'week' | 'focus' | 'settings' | 'instrumentation' | 'updates' | 'hardware';
...
const items: { key: NavKey; label: string; icon: string }[] = [
  ...
  { key: 'taby', label: 'Taby', icon: '✦' }, { key: 'help', label: 'Help', icon: '?' }, { key: 'feedback', label: 'Feedback', icon: '✎' }, { key: 'day', label: 'Day', icon: '□' }, { key: 'week', label: 'Week', icon: '▦' },
  { key: 'focus', label: 'Focus', icon: '◉' }, { key: 'settings', label: 'Settings', icon: '⚙' },
  { key: 'instrumentation', label: 'Events', icon: '⌁' }, { key: 'updates', label: 'Updates', icon: '↟' }, { key: 'hardware', label: 'Hardware', icon: '▣' },
];
