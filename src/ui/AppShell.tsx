...
export type NavKey = 'home' | 'tasks' | 'notes' | 'reminders' | 'habits' | 'goals' | 'review' | 'taby' | 'help' | 'day' | 'week' | 'focus' | 'settings' | 'instrumentation';
...
const items: { key: NavKey; label: string; icon: string }[] = [
  ...
  { key: 'taby', label: 'Taby', icon: '✦' }, { key: 'help', label: 'Help', icon: '?' }, { key: 'day', label: 'Day', icon: '□' }, { key: 'week', label: 'Week', icon: '▦' },
