...
export function SettingsView({ data, onEvent, onReset, onRestore, onTestNotification, aiFallbackPolicy, onAiFallbackPolicyChange, aiUsage, onApplyImport, onApplyNotion }: Props) {
  ...
  const workspacePreferences = (): WorkspacePreferences => ({ language, twentyFourHour });
