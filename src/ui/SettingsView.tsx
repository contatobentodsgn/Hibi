...
export function SettingsView({ data, onEvent, onReset, onRestore, onTestNotification, aiFallbackPolicy, onAiFallbackPolicyChange, aiUsage, onApplyImport }: Props) {
  ...
  const workspacePreferences = (): WorkspacePreferences => ({ language, twentyFourHour: twentyFour });
