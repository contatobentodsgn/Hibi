...
import { SettingsWorkspace, syncLaunchAtLogin } from '../SettingsView';

describe('Settings notifications action', () => {
  it('exposes a dedicated notifications settings section', () => {
    const markup = renderToStaticMarkup(
      <SettingsWorkspace data={createSeedData()} onEvent={() => undefined} onReset={() => undefined} onTestNotification={() => Promise.resolve(true)} />,
    );
