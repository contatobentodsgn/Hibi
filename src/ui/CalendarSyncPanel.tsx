...
export function CalendarSyncPanel({ state, onConnect, onChangeMode, onSync, onResolveConflict }: Props) {
  return <section className="calendar-sync-panel" aria-label="Calendários conectados">
    <div className="calendar-sync-heading"><div><p className="eyebrow">CALENDÁRIO</p><h3>Calendários conectados</h3><p className="muted">Reuniões entram para proteger seu tempo. Publicar um bloco do Pixano é sempre uma escolha explícita.</p></div></div>
