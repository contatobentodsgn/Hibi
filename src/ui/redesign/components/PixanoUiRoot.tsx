...
type PixanoUiRootProps = Readonly<{ children: ReactNode }> & Omit<HTMLAttributes<HTMLDivElement>, 'children'>;
 ...
 */
export function PixanoUiRoot({ children, className, ...rest }: PixanoUiRootProps) {
