...
export type ImportCandidate = Readonly<{ remoteId: string; revision?: string; pixanoId?: string; title: string; kind: 'task' | 'email'; source?: string; status?: 'open' | 'paused' | 'completed'; deadline?: string; durationMinutes?: number; description?: string }>
