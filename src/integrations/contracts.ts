...
export type IntegrationExecutionResult = Readonly<{ ok: boolean; status?: number; error?: string; remoteId?: string; revision?: string; items?: readonly IntegrationExecutionItem[] }>
